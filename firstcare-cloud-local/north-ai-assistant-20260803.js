    ...
    <div class="north-ai-overlay" aria-hidden="true">
      <section class="north-ai-panel" role="dialog" aria-modal="true" aria-labelledby="north-ai-title">
        <header class="north-ai-header">
          <span class="north-ai-brand-mark" aria-hidden="true"></span>
          <div class="north-ai-title"><h2 id="north-ai-title">华北经营助手</h2><p>基于驾驶舱已验证数据回答</p></div>
          <span class="north-ai-readonly">只读</span>
        ...
        <main class="north-ai-conversation" aria-live="polite">
          <section class="north-ai-welcome">
            <div class="north-ai-kicker">North China · Business Copilot</div>
            <h3>你好，我是华北经营助手</h3>
            <p>可以查询APH回款执行、绿仔官方收缴率、跨源口径差异和数据质量。缺失或未验证的数据会明确显示“不可用”，不会补成0。</p>
        ...
        <footer class="north-ai-composer-wrap">
          <form class="north-ai-composer">
            <textarea class="north-ai-input" rows="1" maxlength="500" placeholder="问问华北经营数据…" aria-label="输入经营问题"></textarea>
