/* R63：CSP 安全的确定性启动器。统一移除标题区解释性说明，欠费分析仍按原有集成方式挂载。 */
const RELEASE = 'r63-app-bootstrap-20260813-v1'
...
if (logicalRoute && !token) {
  ...
  await import('/assets/cockpit-r63-no-header-explainers-20260813-v1/app-G7HUEEER.js')
