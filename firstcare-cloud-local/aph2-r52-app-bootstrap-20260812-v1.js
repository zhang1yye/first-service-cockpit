/* R52：CSP 安全的确定性启动器。仅为欠费分析挂载业务内容；系统管理直接由 /admin 承载。 */
const RELEASE = 'r52-app-bootstrap-20260812-v1'
...
if (logicalRoute && !token) {
  ...
  await import('/assets/cockpit-r51-cloud-remediation-20260812-v1/app-G7HUEEER.js')
