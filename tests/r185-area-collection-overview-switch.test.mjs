...
const release = 'cockpit-r185-area-collection-overview-switch-20260901-v1'
...
const bootstrap = fs.readFileSync(path.join(payload, 'releases', release, 'aph2-r185-area-collection-overview-switch-20260901-v1.js'), 'utf8')
...
test('R185继续保留片区执行排名到回款额执行评估的联动', () => {
  ...
  assert.match(index, new RegExp(`type="module"[^>]+releases/${release}/aph2-r185-area-collection-overview-switch-20260901-v1\\.js`))
...
test('R185片区筛选后按正式中心收缴率加权显示片区综合收缴率', () => {
